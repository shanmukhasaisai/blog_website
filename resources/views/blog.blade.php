            ...
            <div>
                ...
                <div class="tm-comment tm-mb-45">
                    <figure class="tm-comment-figure">
                        <img src="{{ asset('img/user.png') }}" alt="Image" class="mb-2 rounded-circle img-thumbnail" width="64px">
    ...
    <aside class="col-lg-4 tm-aside-col">
        <div class="tm-post-sidebar">
            ...
            <a href="{{ route('website.blog', $row->url_slug) }}" class="d-block tm-mb-40">
                <figure>
                    @if($row->image)
                    <img src="{{ asset(''.$row->image) }}" alt="Image" class="mb-3 img-fluid">
                    @else
                    <img src="{{ asset('img/placeholder.jpg') }}" alt="Image" class="mb-3 img-fluid">
                    @endif
